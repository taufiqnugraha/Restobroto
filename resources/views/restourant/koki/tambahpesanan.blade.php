...
<div class="col-lg-12">
        ...
        <div class="form-group row add">
            ...
            <div class="col-md-3">
            <input type="text" class="form-control" id="jenis_makanan_minuman" name="jenis_makanan_minuman"
            placeholder="jenis makanan minuman" required>
            <p class="error text-center alert alert-danger hidden"></p>
            </div>
            <div class="col-md-3">
                        ...
                        <div id="popup" class="modal fade" role="dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                        <button type="submit" class="btn btn-success" id="add" data-dismiss="modal">
                                    Antarkan</button>
